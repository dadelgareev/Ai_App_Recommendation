...
def process_category(scraper, main_category, category_info):
    ...
    new_files = scraper.update_links_file_txt(f'{subcategory}.txt', href_list)
    scraper.create_and_append_csv(new_files, f'{subcategory}.csv', main_category)
...
for i in range(1, 2):
    ...
    scraper.create_and_append_csv_json(f'{subcategory}.json',f'{subcategory}.csv',"women_clothes")
