...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in image_embedding_pb2_grpc.py depends on'
...
class ImageEmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SendEmbedding = channel.unary_unary(
                '/image_embedding.ImageEmbeddingService/SendEmbedding',
...
def add_ImageEmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendEmbedding': grpc.unary_unary_rpc_method_handler(
                    servicer.SendEmbedding,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'image_embedding.ImageEmbeddingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('image_embedding.ImageEmbeddingService', rpc_method_handlers)
...
class ImageEmbeddingService(object):
    ...
    def SendEmbedding(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/image_embedding.ImageEmbeddingService/SendEmbedding',
            image__embedding__pb2.EmbeddingRequest.SerializeToString,
            image__embedding__pb2.EmbeddingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
