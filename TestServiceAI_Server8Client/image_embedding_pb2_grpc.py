...
class ImageEmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessImage = channel.unary_unary(
                '/ImageEmbeddingService/ProcessImage',
...
def add_ImageEmbeddingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ImageEmbeddingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ImageEmbeddingService', rpc_method_handlers)
