...
grpc_client_AI = ImageEmbeddingClient(server_address="localhost:50051")
grpc_client_CSV = CsvUploaderClient(server_address="localhost:50052")
def process_category(scraper, main_category, category_info):
    ...
    scraper.create_and_append_csv(new_files,f'{subcategory}.csv',main_category, grpc_client_AI)
    grpc_client_CSV.upload_csv(f'{subcategory}_temp.csv')
