...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in fileexchange_pb2_grpc.py depends on'
...
class FileExchangeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Upload = channel.stream_unary(
                '/FileExchange.FileExchange/Upload',
...
class FileExchangeServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FileExchangeServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'FileExchange.FileExchange', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('FileExchange.FileExchange', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class FileExchange(object):
    """Missing associated documentation comment in .proto file."""
