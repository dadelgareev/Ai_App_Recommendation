...
fig1, axes1 = plt.subplots(8, 5, figsize=(20, 8))
...
for i, (image_path, similarity) in enumerate(cosine_results[:39], start=1):
...
fig2, axes2 = plt.subplots(8, 5, figsize=(20, 8))
...
for i, (image_path, norm_val) in enumerate(norm_results[:39], start=1):
    img = Image.open(image_path)
    axes2[i].imshow(img)
